...
uses
  ...
  uDtmnConexao in 'DataModule\uDtmnConexao.pas' {dtmConexao: TDataModule},
  ...
  uTelaHerancaConsulta in 'Herança\uTelaHerancaConsulta.pas' {frmTelaHerancaConsulta},
  uConCategorias in 'Consultas\uConCategorias.pas' {frmConCategorias},
