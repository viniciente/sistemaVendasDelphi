object frmPrincipal: TfrmPrincipal
    ...
    object Panel4: TPanel
      ...
      object DBChart2: TDBChart
        ...
        object Series2: TPieSeries
          ...
          Marks.Symbol.Visible = True
          Marks.Color = clBlack
          DataSource = DtmGrafico.qryVendaPorCliente
          Title = 'Valor de Venda por Cliente na Ultima Semana'
          XLabelsSource = 'Label'
          XValues.Order = loAscending
          YValues.Name = 'Pie'
          YValues.Order = loNone
  ...
  object mainPrincipal: TMainMenu
    ...
    object CADASTRO1: TMenuItem
      ...
      object USUARIOVSAES1: TMenuItem
        Caption = 'USUARIO VS A'#199#213'ES'
        OnClick = USUARIOVSAES1Click
      end
      object N4: TMenuItem
        Caption = '-'
      end
