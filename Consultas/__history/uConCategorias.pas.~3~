...
type
  TfrmConCategorias = class(TfrmTelaHerancaConsulta)
...
procedure TfrmConCategorias.FormCreate(Sender: TObject);
begin
  aCampoId := 'categoriasId';
