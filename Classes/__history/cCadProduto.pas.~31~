...
uses System.Classes, Vcl.Controls, Vcl.ExtCtrls, Vcl.Dialogs,
     FireDAC.Stan.Intf, FireDAC.Stan.Option,
      ...
      System.SysUtils, Vcl.Imaging.jpeg, Vcl.Graphics, System.Variants;
      // lista de Units
...
type
  ...
  published
    ...
    property categoriasId :Integer read F_categoriasId write F_categoriasId;
...
var Qry:TFDQuery;
begin
  if MessageDlg('Apagar o Regsitro: '+#13+#13+
...
begin
  try
    ...
    Qry.ParamByName('categoriasId').AsInteger :=Self.categoriasId;
    Qry.ParamByName('fornecedorId').AsInteger  :=Self.fornecedorId;
...
begin
  try
    ...
    Qry.Connection:=FdConexao;
    Qry.SQL.Clear;
    Qry.SQL.Add ('INSERT INTO produtos (nome, descricao, valor, quantidade, categoriasId, foto, fornecedorId) ' +
                'VALUES (:nome, :descricao, :valor, :quantidade, :categoriasId, :foto, :fornecedorId)');
...
begin
  ...
  try
    Qry.Connection := FdConexao;
    Qry.SQL.Clear;
    Qry.SQL.Add('SELECT produtoId, nome, descricao, valor, quantidade, categoriasId, foto, fornecedorId ');
