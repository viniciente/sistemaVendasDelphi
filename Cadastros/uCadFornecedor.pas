...
type
  TfrmCadFornecedor = class(TfrmTelaHeranca)
    ...
    procedure FDQuery1cnpjGetText(Sender: TField; var Text: string; DisplayText: Boolean);
...
begin
  ...
  if edtFornecedorId.Text <> EmptyStr then
    oFornecedor.codigo := StrToInt(edtFornecedorId.Text)
  else
    oFornecedor.codigo := 0;

  oFornecedor.nomeFantasia           := edtNomeFantasia.Text;
...
procedure TfrmCadFornecedor.FDQuery1cnpjGetText(Sender: TField; var Text: string; DisplayText: Boolean);
begin
  Text := TFuncao.FormatarCNPJ(Sender.AsString);
end;

procedure TfrmCadFornecedor.FDQuery1telefoneGetText(Sender: TField; var Text: string; DisplayText: Boolean);
begin
...
begin
  inherited;
  oFornecedor := TFornecedor.Create(dtmConexao.FDConexao);
end;
