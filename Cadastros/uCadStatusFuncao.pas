...
begin
  ...
  begin
    MessageDlg('O nome do perfil é obrigatório.', mtWarning, [mbOK], 0);
  ...
  begin
    MessageDlg('Já existe um perfil com esse nome.', mtWarning, [mbOK], 0);
    edtDescricao.SetFocus;
    Exit;
  end;
...
begin
  ...
  inherited; // ? herdado por ÚLTIMO — ele abre o FDQuery1 no FormShow
