object frmRelCadClienteFicha: TfrmRelCadClienteFicha
  Left = 0
  Top = 0
  Caption = 'Relatorio Ficha do CLiente'
  ClientHeight = 463
  ClientWidth = 805
  Color = clBtnFace
  ...
  object Relatorio: TRLReport
    ...
    object lblLIstagemCategoria: TRLLabel
      Left = 38
      Top = 48
      Width = 188
      Height = 27
  ...
  object QryCliente: TFDQuery
    ...
    SQL.Strings = (
      ...
      '       p.descricao AS tipoPessoa'
      '  FROM clientes c'
      '  LEFT JOIN statusClientes s ON (s.statusId = c.statusId)'
    ...
    object QryClientedataNascimento: TSQLTimeStampField
    ...
    object QryClientestatusDescricao: TStringField
      FieldName = 'statusDescricao'
      Origin = 'statusDescricao'
    end
    object QryClientetipoPessoa: TStringField
